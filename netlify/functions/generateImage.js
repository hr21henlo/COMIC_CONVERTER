exports.handler = async (event, context) => {
    ...
    try {
        ...
        // If Graphical Style is selected, go straight to vector SVG path
        if (style === 'graphical design style') {
            console.log("📊 Backend Graphical selection detected: generating SVG graphic...");
            return await getFallbackResponse("Direct Graphical Style request");
        }
        ...
        try {
            ...
            return await getFallbackResponse(nvidiaErr.message);
        }
